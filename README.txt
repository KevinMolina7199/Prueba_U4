...
a persistence unit "eva62MolinaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Molina/pom.xml":
...
artifact ("eva62Molina.war") is already built. You can build
